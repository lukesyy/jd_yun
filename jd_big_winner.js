...
//https://618redpacket.jd.com/?activityId=DA4SkG7NXupA9sksI00L0g&redEnvelopeId=0a41672cd1224032b4b9594827ca5a2333261624291264309&inviterId=TLkD8_PycMVws_9HtL2YLxaNNJ_CYAljNZtiKqj2jvI&helpType=1&ad_od=share&utm_source=androidapp&utm_medium=appshare&utm_campaign=t_335139774&utm_term=QQfriends
//帮助作者
function helpAuthor() {
  return new Promise(async (resolve) => {
    let options = {
      url: `https://api.m.jd.com/?functionId=openRedEnvelopeInteract&body={"linkId":"DA4SkG7NXupA9sksI00L0g","redEnvelopeId":"0a41672cd1224032b4b9594827ca5a2333261624291264309","inviter":"TLkD8_PycMVws_9HtL2YLxaNNJ_CYAljNZtiKqj2jvI","helpType":"1"}&t=1623064535450&appid=activities_platform&clientVersion=3.3.6`,
      headers: {
        "Origin": "https://618redpacket.jd.com",
        "Host": "api.m.jd.com",
        "User-Agent": "jdapp;iPhone;9.5.2;14.3;6898c30638c55142969304c8e2167997fa59eb53;network/wifi;ADID/F108E1B6-8E30-477C-BE54-87CF23435488;supportApplePay/0;hasUPPay/0;hasOCPay/0;model/iPhone9,2;addressid/4585826605;supportBestPay/0;appBuild/167650;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1",
...
function helpAuthor2() {
  return new Promise(async (resolve) => {
    let options = {
      url: `https://api.m.jd.com/?functionId=openRedEnvelopeInteract&body={"linkId":"DA4SkG7NXupA9sksI00L0g","redEnvelopeId":"56aa702237434bf687c214f4cea3169985881624034100882","inviter":"TLkD8PycMVws9HtL2YLxaNNJCYAljNZtiKqj2jvI","helpType":"2"}&t=1623064535450&appid=activities_platform&clientVersion=3.3.6`,
      headers: {
        "Origin": "https://618redpacket.jd.com",
        "Host": "api.m.jd.com",
        "User-Agent": "jdapp;iPhone;9.5.2;14.3;6898c30638c55142969304c8e2167997fa59eb53;network/wifi;ADID/F108E1B6-8E30-477C-BE54-87CF23435488;supportApplePay/0;hasUPPay/0;hasOCPay/0;model/iPhone9,2;addressid/4585826605;supportBestPay/0;appBuild/167650;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1",
