...
async function joinLeaderTuan() {
  ...
  $.tuanIdS = null;
  if (!$.tuanIdS) await updateTuanIdsCDN('https://gitee.com/zero205/updateTeam/raw/main/jd_updateFactoryTuanId.json');
  if ($.tuanIdS && $.tuanIdS.tuanIds) {
    for (let tuanId of $.tuanIdS.tuanIds) {
      if (!tuanId) continue
      await JoinTuan(tuanId);
...
function updateTuanIds(url = 'https://raw.githubusercontent.com/zero205/updateTeam/master/jd_updateFactoryTuanId.json') {
  return new Promise(resolve => {
...
function requireConfig() {
  return new Promise(async resolve => {
    await updateTuanIdsCDN('https://gitee.com/zero205/updateTeam/raw/master/shareCodes/jd_updateFactoryTuanId.json');
