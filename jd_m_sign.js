...
async function jdsign() {
	try {
		...
		await $.wait(2000)
		await getInfo('https://pro.m.jd.com/mall/active/2Tjm6ay1ZbZ3v7UbriTj6kHy9dn6/index.html') //清洁签到
		await $.wait(2000)
    ...
    await $.wait(2000)
		await doInteractiveAssignment('3TuLASyAahaaunJEJvooc6GLwDAm', '33fAd77F5EJXTgWSazdPBepdgzsF') //校园签到
	} catch (e) {
		$.logErr(e)
	}
}
