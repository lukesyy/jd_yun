...
## 2.进入空白的库创建Actions ①点击Actions ②点击New workflow ③点击Node.js里的Set up this workflow ④把这个代码[去复制代码](https://github.com/lukesyy/jd_yun/blob/main/.github/workflows/syncGit.yml)放进去保存执行一次就好了
